...
if( isset($_POST['first_name']) && $user->auth()->user_role_id == 1 ){

	$user->updateUser($user->auth()->id, $user->request());
	return redirect( 'account?page=details', 'Your details have been updated' );
